    ...
    <main class="content welcome-screen" :class="{ 'modal-open': showCreateAccountCard }" v-if="!connectedInfo && !loading">
      ...
      <div class="container">
        ...
        <div class="box">
          ...
          <!-- Botão Voltar fora do card (apenas passo 3, mobile) -->
          <button
            v-if="showCreateAccountCard && currentAccountStep === 3"
            class="link-button back-button-step3"
          ...
          <div v-else class="video-wrapper-card">
        ...
        <div v-if="!showCreateAccountCard" class="note">Essa tela aparece apenas no primeiro acesso ou se sua conta Deriv estiver desconectada.</div>
      </div>
    </main>
