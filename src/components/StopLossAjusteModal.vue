  ...
  <transition name="modal-fade">
    <div v-if="visible" class="stop-loss-modal-overlay" @click.self="handleClose">
      <div class="stop-loss-modal">
        ...
        <h2 class="modal-title">STOP LOSS ATINGIDO</h2>
        
        <p class="modal-message">
          A sua próxima entrada violaria o stop loss de precisão, para preservar o seu capital o sistema encerrou antes e aceitou a perda.
        </p>
