<template>
  <transition name="modal-fade">
    <div v-if="visible" class="stop-loss-modal-overlay" @click.self="handleClose">
      <div class="stop-loss-modal consecutive-loss-variant">
        <div class="modal-icon-container">
          <div class="modal-icon">
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="32" cy="32" r="30" stroke="#FF5252" stroke-width="3"/>
              <path d="M22 42L32 32L42 42M22 32L32 22L42 32" stroke="#FF5252" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
        </div>
        
        <h2 class="modal-title">PROTEÇÃO POR PERDAS CONSECUTIVAS</h2>
        
        <p class="modal-message">
          O sistema identificou uma sequência de 3 perdas consecutivas, indicando uma instabilidade atípica no mercado. Para preservar seu capital, as operações foram interrompidas automaticamente.
        </p>
        ...
        <p class="info-message">
          A segurança do seu capital é nossa prioridade. Evite operar em mercados altamente instáveis.
        </p>
        
        <button class="confirm-button" type="button" @click="handleConfirm">
          Confirmar e Encerrar Sessão
        </button>
      </div>
    </div>
  </transition>
