			...
			allAgents: [
				{
					...
					description: 'Estatística de Dígitos',
					analysis: 'Estatística de Dígitos',
...
/* Prevenção de duplicação de ícones pelo FontAwesome */
...
/* Força a exibição de apenas um elemento no wrapper de ícone */
