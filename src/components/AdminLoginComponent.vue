    ...
    <div class="w-full max-w-7xl flex items-center justify-center login-container-wrapper">
      ...
      <div id="login-section" class="w-[480px]">
        <div class="bg-white border border-zenix-card-border rounded-2xl p-10 login-card-shadow login-card">
          ...
          <!-- Logo -->
          <div class="mb-12 flex flex-col items-center justify-center login-logo">                                                                                                                                                                          
          ...
          <div class="mb-8 header-section">
            <h1 class="text-3xl font-semibold text-zenix-text-dark mb-3 header-title">Acesso Administrativo</h1>
            <p class="text-sm text-zenix-gray leading-relaxed forgot-text header-subtitle">Entre com suas credenciais de administrador para acessar o painel.</p>
          </div>
          ...
          <div class="links-section">
            <router-link to="/login" class="text-sm text-zenix-gray hover:text-zenix-text-dark transition-colors link-left">
...
export default {
  ...
  data() {
    return {
      ...
      isLoading: false,
      showPassword: false,
      fullTitle: 'ZENIX ADMIN',
      fullSubtitle: 'Gerenciamento avançado e controle total da plataforma Zenix.',
      typedTitle: '',
      typedSubtitle: '',
      fullLogoTitle: 'ZENIX ADMIN',
      typedLogoTitle: '',
      isMobile: false,
