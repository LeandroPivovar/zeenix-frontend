        ...
        <div class="sbt-sidebar-brand">
            <div class="sbt-brand-logo-container">
                <span class="sbt-logo-text font-black">
                    ...
                    <span class="sbt-logo-suffix">
                        <span class="sbt-white">ENI</span>
                        <span class="sbt-green text-[#22C55E]">X</span>
                    </span>
                </span>
            </div>
...
<style src="../assets/css/components/sidebar-transparent.css"></style>