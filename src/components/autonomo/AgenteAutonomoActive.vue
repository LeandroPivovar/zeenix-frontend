		...
		<div class="chart-section">
			...
			<div class="chart-content">
				...
				<div id="contentHistorico" :class="['history-content', { hidden: abaAtiva !== 'historico' }]">
					...
					<div class="table-scroll-wrapper"> <table class="operations-table">
							<thead>
								<tr>
									<th>Hora</th>
									<th>Ativo</th>
	...
	computed: {
		...
		historicoOperacoesFiltradas() {
			...
			const getDateNDaysAgo = (n) => {
				const date = new Date('2025-11-25'); // Data de referência simulada (Hoje)
				date.setDate(date.getDate() - n + 1); // +1 para incluir o dia atual
			...
			switch (filtroDataSelecionado) {
				...
				case '30d':
					// Simula últimos 30 dias (25/11 até 27/10)
...
/* Adicionado um wrapper para que apenas a tabela role, se necessário */
...
.operations-table th {
	...
	background-color: #0e0f0f; /* Para cabeçalho fixo durante a rolagem */
	position: sticky;
	top: 0;
	z-index: 10;
}
