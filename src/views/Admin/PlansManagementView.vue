<template>
    <div class="dashboard-layout" ref="layoutContainer">
        ...
        />
            ...
            <!-- Page Header -->
            <div class="page-header-plans" v-if="!isFormVisible" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; margin-top: 2rem; width: 100%;">
