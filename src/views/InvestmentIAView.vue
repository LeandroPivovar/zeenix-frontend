                                    ...
                                    <div class="selector-content">
                                        <div class="selector-left">
                                            <div class="selector-icon-active">
                                                <div v-if="selectedStrategyDerivIcons" class="flex gap-1 justify-center items-center">
                                                    <img v-for="icon in selectedStrategyDerivIcons" :key="icon" :src="icon" class="w-5 h-5" />
                                                </div>
                                    ...
                                    <div class="agents-modal-list">
                                        ...
                                        >
                                            <div class="agent-option-icon">
                                                <div v-if="strategy.derivIcons" class="flex gap-1 justify-center items-center">
