          ...
          <div class="max-w-7xl mx-auto px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8">
              <div>
                ...
                <p
                  class="text-zenix-label text-xs leading-relaxed mb-6 opacity-60"
                >
                  Plataforma inteligente de investimentos com IA, copy trading e
                  automação.
                </p>
                <div class="flex items-center space-x-4">
                  <a
                    href="#"
                    class="text-zenix-label hover:text-zenix-text transition-colors opacity-50"
                  >
              ...
              <div>
                <h3 class="text-sm font-semibold text-zenix-text mb-4">
                  Produtos
                </h3>
                <ul class="space-y-2">
                  <li>
                    <a
                      href="#"
                      class="text-zenix-label hover:text-zenix-text text-xs transition-colors"
                      >Copy Trading</a
                    >
                  </li>
                  <li>
